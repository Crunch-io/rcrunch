...
deps:
	R --slave -e 'Nexus <- "https://rproxy:I0VktB3jZdplfsEgeiAR@nexus.dev.crint.net/repository/rcrunch/"; if (!dir.exists(file.path(.libPaths()[1], "devtools"))) install.packages("devtools", repo=Nexus); devtools::install_deps(dependencies=TRUE)'
