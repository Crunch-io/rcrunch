...
deps:
	R --slave -e 'cran <- "http://cran.at.r-project.org"; if (!dir.exists(file.path(.libPaths()[1], "devtools"))) install.packages("devtools", repo=cran); devtools::install_deps(dependencies=TRUE)'
