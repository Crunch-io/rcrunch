structure(list(url = "https://app.crunch.io/api/datasets/1/export/csv/",
    status_code = 202L, headers = structure(list(allow = "GET, HEAD, OPTIONS, POST",
        ...
        date = "Fri, 12 Jan 2018 14:23:13 GMT", location = "https://player-crunch-io.s3.amazonaws.com/export/dataset_exports/24de0ff501aa3225958678898cd26d08/test-ds.csv?Signature=SKknqNLKd2vJu3EcxKhOJxOjp4c%3D&Expires=1515770593&AWSAccessKeyId=AKIAJT4CEBNJXNPF3NZA",
