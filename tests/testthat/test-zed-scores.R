...
test_that("z-scores input validation)", {
    not_a_cube <- data.frame(foo = c(1, 2, 3))
    expect_error(z.scores(not_a_cube, 1),
                 paste0(dQuote(substitute("not_a_cube")), " must be a CrunchCube."))
})

# 3-d cubes and cubes with cat arrays
# TODO: add cat arrays
three_dee_cube <- loadCube(test_path("cubes/3d-cube.json"))
three_dee_dims <- list(feelings = c("Extremely Happy", "Somewhat Happy",
...
test_that("cubify can handle dimensions higher than two", {
    expect_equal(as.array(three_dee_cube),
                 cubify(as.array(three_dee_cube), dims = three_dee_dims))
})

test_that("z-scores input validation)", {
    expect_equal(z.scores(three_dee_cube, 1),
                 cubify(c(-0.287573475320258, -1.60211840475331, 0.0879848065089329,
                          0.319434457770027, 1.01056571041289, 1.3228269017735,
                          -0.601452374912244, 1.77103873046154, -2.02813655902525,
                          -0.941441160818571, -0.0932053750822662, -1.38907689093281,
                          -2.79347302957763, 1.31486823006595, 1.20722100135811,
                          -2.54381213501984, 1.90753363405256, -2.34189467903286,
                          0.92593383222907, -0.0689202551377089, 0.304246447391576,
                          2.12609234413008, -1.11153210511023, -1.32735889710936,
                          -1.36053528335389, -1.28586053393971, -0.20275627462115,
                          0.265274780608206, 0.517818011331104, 0.413681637917805,
                          0.672152005338754, -1.60247534789407, 1.07606974662878,
                          -0.622213679435658, 0.209903254162225, 0.304324934251837,
                          0.206113353163063, 1.5764762353808, 0.0199517766626663,
                          -2.77409515326232, -0.288078263393768, 0.550808791927095,
                          -3.01448356716981, -0.623404746311804, 1.72711594383751,
                          0.713016890505935, -0.48101008912227, 0.996016644817069,
                          0.466771983581042, -2.23261544311382), dims = three_dee_dims))
    expect_equal(z.scores(three_dee_cube, 2),
                 cubify(c(-0.0687877045209776, -1.67099974068276, 0.628010148938364,
                          0.414540577588982, 1.01166097192103, 1.42265504617555,
                          -0.70459938945616, 2.08248420607569, -1.84249978991431,
                          -0.929335977423058, 0.206059795046099, -1.39005538313024,
                          -1.82200508503472, 1.54344909022083, 1.36474702579531,
                          -2.65869329867217, 1.42738503161536, -1.86883015978095,
                          0.626651460862825, -0.514913904388424, 0.0153457449216316,
                          2.11756863522777, -1.34335541554877, -2.35740249534855,
                          -2.55070552455033, -1.43021391479076, -0.0686972016021046,
                          -0.292209647709503, 0.41365132085176, 0.415255190547697,
                          0.43252507779294, -1.3453334672542, 0.433096142282297,
                          -0.701858826727453, 0.215340154949422, 0, 0.205834373732109,
                          0.928291996623898, -0.202741368960124, -3.10077166810971,
                          -0.100392696585095, 1.01967490825827, -2.91009489530015,
                          -0.308677859940276, 2.14448903870967, 1.18169132076921,
                          0.0153344729761787, 1.18238642091572, 1.03326419533872,
                          -2.36193936256505), dims = three_dee_dims))
    expect_equal(z.scores(three_dee_cube, 3),
                 cubify(c(0.72678598961574, -0.647720479683281, 0.0503362212998128,
                          0.0658478006925567,  0.591336262598481, 0.591336262598481,
                          0.72678598961574, 0.591336262598481,  -0.647720479683281,
                          -0.527277332173778, 0.0503362212998128, -0.647720479683281,
                          -2.04756997555027, 1.16192275612968, 2.57002162833203,
                          -1.51482125782653,  0.591336262598481, 0, 0.642237383448836,
                          -1.49600776441344, -0.647720479683281,  1.30644806649679,
                          -1.51482125782653, -1.51482125782653, 0, -0.717157134427402,
                          0.639139127276242, -0.0496693397245639, -0.0649754132959938,
                          -0.583501918896859, -0.583501918896859, -0.717157134427402,
                          -0.583501918896859,  0.639139127276242, 0.52029167594466,
                          -0.0496693397245639, 0.639139127276242,  2.02044265737923,
                          -1.14652897292711, -2.53597258715116, 1.49475208376947,
                          -0.583501918896859, 0, -0.633728674076171, 1.47618784172645,
                          0.639139127276242, -1.28913953355433, 1.49475208376947,
                          1.49475208376947,  0), dims = three_dee_dims))
})
