...
with_test_authentication({
    ...
    test_that("Can modify subtotals in place", {
        # assert known shape
        expect_equal(names(subtotals(ds$v4)), c("This is a subtitle", "B alone",
                                                "C alone", "B+C"))
