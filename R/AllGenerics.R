...
setGeneric("secure", function(x) standardGeneric("secure"))
setGeneric("unsecure", function(x) standardGeneric("unsecure"))
...
setGeneric("secured", function(x) standardGeneric("secured"))
