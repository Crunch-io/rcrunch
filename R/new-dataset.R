...
#' @param na See \code{\link[utils:write.table]{utils::write.csv()}}. This just changes
#' the default to a Crunch-friendly empty string.
#' @param row.names logical: write out row names? See
