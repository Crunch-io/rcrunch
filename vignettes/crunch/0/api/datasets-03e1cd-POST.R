structure(list(url = "/api/datasets/", status_code = 201L, headers = structure(list(
    ...
    `content-type` = "application/json;charset=utf-8", date = "Thu, 10 May 2018 21:54:28 GMT", 
    location = "/api/datasets/d2d639/", server = "nginx", `set-cookie` = "REDACTED", 
...
"list")), all_headers = list(structure(list(status = 201L, version = "HTTP/1.1", 
    headers = structure(list(allow = "GET, HEAD, OPTIONS, PATCH, POST", 
        ...
        date = "Thu, 10 May 2018 21:54:28 GMT", location = "/api/datasets/d2d639/", 
...
"version", "headers"))), cookies = structure(list(domain = ".crunch.io", 
    flag = TRUE, path = "/", secure = FALSE, expiration = structure(1557525268, class = c("POSIXct", 
    "POSIXt")), name = "token", value = "REDACTED"), .Names = c("domain", 
"flag", "path", "secure", "expiration", "name", "value"), row.names = c(NA, 
-1L), class = "data.frame"), content = charToRaw("null"), date = structure(1525989268, class = c("POSIXct", 
"POSIXt"), tzone = "GMT"), times = structure(c(0, 3.9e-05, 4e-05, 
0.000485, 0.000496, 1.61508), .Names = c("redirect", "namelookup", 
