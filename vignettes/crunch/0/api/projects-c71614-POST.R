structure(list(url = "/api/projects/", status_code = 201L, headers = structure(list(
    date = "Thu, 21 Nov 2024 16:31:42 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "0", location = "/api/projects/264e6b/", 
...
"list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
    headers = structure(list(date = "Thu, 21 Nov 2024 16:31:42 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "0", 
        location = "/api/projects/264e6b/", server = "CherryPy/18.9.0", 
    ...
    content = charToRaw(""), date = structure(1732206702, class = c("POSIXct", 
    "POSIXt"), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.7e-05, 
    connect = 0, pretransfer = 0.000152, starttransfer = 0.308279, 
    total = 0.308307)), class = "response")
