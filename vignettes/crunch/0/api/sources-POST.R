structure(list(url = "/api/sources/", status_code = 201L, headers = structure(list(
    date = "Fri, 10 Jan 2025 15:51:43 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "87", location = "/api/sources/839935/", 
...
"list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
    headers = structure(list(date = "Fri, 10 Jan 2025 15:51:43 GMT", 
        ...
        location = "/api/sources/839935/", server = "CherryPy/18.9.0", 
    ...
    connect = 0, pretransfer = 0.00051, starttransfer = 0.359593, 
    total = 0.359672)), class = "response")
