structure(list(url = "/api/sources/", status_code = 201L, headers = structure(list(
    date = "Mon, 04 May 2020 21:39:26 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "86", location = "/api/sources/cec83c/", 
...
"list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
    headers = structure(list(date = "Mon, 04 May 2020 21:39:26 GMT", 
        ...
        location = "/api/sources/cec83c/", server = "nginx", 
...
-1L), class = "data.frame"), content = charToRaw("{\"element\": \"shoji:view\", \"self\": \"/api/sources/\"}"), 
    ...
    connect = 2.7e-05, pretransfer = 0.00014, starttransfer = 0.000145, 
    total = 1.060191)), class = "response")
