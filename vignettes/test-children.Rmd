...
wrong. However, this approach has the disadvantage that it allows your mocks to be 
completely divorced from the crunch API and rcrunch package. Therefore it will be harder
for your tests to get updated in the event that the behavior of rcrunch changes.
