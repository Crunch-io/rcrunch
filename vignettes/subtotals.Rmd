...
* `position` should the subtotal be displayed `relative` to an existing category, at the `beginning` of the category list or at the `end` of that list
...
If you don't want to see the subtotals as part of these summaries for some reason, you can suppress the suppress them with the `noTransforms()` function like so: 
