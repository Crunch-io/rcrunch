...
```{r}
query(slide3) <- ~Professional + TabsSpaces
slide3
```
...
You can copy slides either within a single deck, or between decks by assignment. 

```{r}
titles(gender_deck)
gender_deck[[5]] <- gender_deck[[1]]
titles(gender_deck)
titles(gender_deck)[1] <- "test"
titles(gender_deck)
```
