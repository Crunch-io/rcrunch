...
> This ordering API is being phased out in favor of the new "variable folders" API, which is currently in a beta testing phase. This vignette is left here for reference, but you are encouraged to try the new methods. See [the new vignette](variable-order.html) for details.
