structure(list(url = "/api/datasets/8bf19e/actions/", status_code = 202L, 
    headers = structure(list(date = "Thu, 21 Nov 2024 18:54:02 GMT", 
    ...
    "list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 21 Nov 2024 18:54:02 GMT", 
            ...
            `content-length` = "176", server = "CherryPy/18.9.0", 
    ...
    content = charToRaw("{\"element\": \"shoji:view\", \"self\": \"/api/datasets/8bf19e/actions/\", \"value\": \"/api/progress/\"}"), 
    date = structure(1732215242, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.7e-05, 
    connect = 0, pretransfer = 0.000118, starttransfer = 0.437328, 
    total = 0.437364)), class = "response")
