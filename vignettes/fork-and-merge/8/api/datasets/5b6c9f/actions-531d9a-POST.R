structure(list(url = "/api/datasets/5b6c9f/actions/", status_code = 202L, 
    headers = structure(list(date = "Thu, 25 Mar 2021 15:26:26 GMT", 
    ...
    "list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 25 Mar 2021 15:26:26 GMT", 
            ...
            `content-length` = "178", server = "nginx", `content-encoding` = "gzip", 
    ...
    date = structure(1616685986, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.6e-05, 
    connect = 2.7e-05, pretransfer = 8.2e-05, starttransfer = 8.7e-05, 
    total = 0.723238)), class = "response")
