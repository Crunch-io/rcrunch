structure(list(url = "/api/datasets/5af735/forks/", status_code = 202L, 
    headers = structure(list(date = "Mon, 03 Mar 2025 17:55:24 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "174", 
        location = "/api/datasets/44c194/", server = "CherryPy/18.9.0", 
    ...
    "list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
        headers = structure(list(date = "Mon, 03 Mar 2025 17:55:24 GMT", 
            ...
            `content-length` = "174", location = "/api/datasets/44c194/", 
    ...
    date = structure(1741024524, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.5e-05, 
    connect = 0, pretransfer = 0.00012, starttransfer = 0.413464, 
    total = 0.413517)), class = "response")
