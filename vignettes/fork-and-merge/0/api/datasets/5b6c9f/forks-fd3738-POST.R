structure(list(url = "/api/datasets/5b6c9f/forks/", status_code = 202L, 
    headers = structure(list(date = "Thu, 25 Mar 2021 15:18:31 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "176", 
        location = "/api/datasets/9540f6/", server = "nginx", 
    ...
    "list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 25 Mar 2021 15:18:31 GMT", 
            ...
            `content-length` = "176", location = "/api/datasets/9540f6/", 
    ...
    date = structure(1616685511, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.3e-05, 
    connect = 2.4e-05, pretransfer = 7.5e-05, starttransfer = 7.9e-05, 
    total = 0.779493)), class = "response")
