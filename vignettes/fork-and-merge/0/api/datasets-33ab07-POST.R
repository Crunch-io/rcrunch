structure(list(url = "/api/datasets/", status_code = 202L, headers = structure(list(
    date = "Mon, 03 Mar 2025 17:55:18 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "176", location = "/api/datasets/5af735/", 
...
"list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
    headers = structure(list(date = "Mon, 03 Mar 2025 17:55:18 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "176", 
        location = "/api/datasets/5af735/", server = "CherryPy/18.9.0", 
    ...
    date = structure(1741024518, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.8e-05, 
    connect = 0, pretransfer = 0.000318, starttransfer = 1.401121, 
    total = 1.402488)), class = "response")
