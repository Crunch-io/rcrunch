structure(list(url = "/api/datasets/5b6c9f/actions/", status_code = 202L, 
    headers = structure(list(date = "Thu, 25 Mar 2021 15:18:37 GMT", 
    ...
    date = structure(1616685517, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.5e-05, 
    connect = 2.6e-05, pretransfer = 7.9e-05, starttransfer = 8.4e-05, 
    total = 0.709562)), class = "response")
