structure(list(url = "/api/datasets/8bf19e/actions/", status_code = 202L, 
    headers = structure(list(date = "Thu, 21 Nov 2024 18:53:30 GMT", 
    ...
    date = structure(1732215210, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.8e-05, 
    connect = 0, pretransfer = 0.000104, starttransfer = 1.569279, 
    total = 1.569356)), class = "response")
