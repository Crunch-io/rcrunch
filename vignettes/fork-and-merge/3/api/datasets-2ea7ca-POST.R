structure(list(url = "/api/datasets/", status_code = 202L, headers = structure(list(
    date = "Wed, 22 Jan 2020 22:28:26 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "176", location = "/api/datasets/7d921e/", 
    ...
    headers = structure(list(date = "Wed, 22 Jan 2020 22:28:26 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "176", 
        location = "/api/datasets/7d921e/", server = "nginx", 
    ...
    flag = TRUE, path = "/", secure = FALSE, expiration = structure(1611268106, class = c("POSIXct", 
...
-1L), class = "data.frame"), content = charToRaw("{\"element\": \"shoji:view\", \"self\": \"/api/datasets/\", \"value\": \"/api/progress/\"}"), 
    date = structure(1579732106, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.3e-05, 
    connect = 2.4e-05, pretransfer = 7.7e-05, starttransfer = 8.1e-05, 
    total = 0.995027)), class = "response")
