structure(list(url = "/api/sources/", status_code = 201L, headers = structure(list(
    date = "Thu, 21 Nov 2024 18:53:35 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "87", location = "/api/sources/da5c55/", 
...
"list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
    headers = structure(list(date = "Thu, 21 Nov 2024 18:53:35 GMT", 
        ...
        location = "/api/sources/da5c55/", server = "CherryPy/18.9.0", 
    ...
    connect = 0, pretransfer = 0.000533, starttransfer = 0.230745, 
    total = 0.230803)), class = "response")
