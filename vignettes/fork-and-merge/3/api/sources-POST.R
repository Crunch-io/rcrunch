structure(list(url = "/api/sources/", status_code = 201L, headers = structure(list(
    date = "Mon, 03 Mar 2025 17:55:34 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "87", location = "/api/sources/122ad7/", 
...
"list")), all_headers = list(list(status = 201L, version = "HTTP/2", 
    headers = structure(list(date = "Mon, 03 Mar 2025 17:55:34 GMT", 
        ...
        location = "/api/sources/122ad7/", server = "CherryPy/18.9.0", 
    ...
    connect = 0, pretransfer = 0.000527, starttransfer = 0.234984, 
    total = 0.235121)), class = "response")
