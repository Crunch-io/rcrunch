structure(list(url = "/api/datasets/8bf19e/actions/", status_code = 202L, 
    headers = structure(list(date = "Thu, 21 Nov 2024 18:53:47 GMT", 
    ...
    date = structure(1732215227, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.8e-05, 
    connect = 0, pretransfer = 0.00013, starttransfer = 0.422246, 
    total = 0.422301)), class = "response")
