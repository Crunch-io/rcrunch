structure(list(url = "/api/datasets/5af735/actions/", status_code = 202L, 
    headers = structure(list(date = "Mon, 03 Mar 2025 17:55:48 GMT", 
    ...
    date = structure(1741024548, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 1.5e-05, 
    connect = 0, pretransfer = 9.1e-05, starttransfer = 0.435569, 
    total = 0.435609)), class = "response")
