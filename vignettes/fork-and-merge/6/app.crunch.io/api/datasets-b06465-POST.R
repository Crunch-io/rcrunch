structure(list(url = "https://app.crunch.io/api/datasets/", status_code = 201L, 
    headers = structure(list(allow = "GET, HEAD, OPTIONS, PATCH, POST", 
        ...
        date = "Mon, 14 May 2018 15:11:57 GMT", location = "https://app.crunch.io/api/datasets/6195f4/", 
    ...
    "list")), all_headers = list(list(status = 201L, version = "HTTP/1.1", 
        ...
        flag = TRUE, path = "/", secure = FALSE, expiration = structure(1557846717, class = c("POSIXct", 
        "POSIXt")), name = "token", value = "REDACTED"), row.names = c(NA, 
    -1L), class = "data.frame"), content = charToRaw("null"), 
    date = structure(1526310717, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4e-05, 
    connect = 4.2e-05, pretransfer = 0.000153, starttransfer = 0.489541, 
    total = 0.489586)), class = "response")
