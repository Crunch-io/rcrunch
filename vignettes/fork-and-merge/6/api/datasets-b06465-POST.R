structure(list(url = "/api/datasets/", status_code = 202L, headers = structure(list(
    date = "Thu, 25 Mar 2021 15:23:55 GMT", `content-type` = "application/json;charset=utf-8", 
    `content-length` = "176", location = "/api/datasets/b5a775/", 
...
"list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
    headers = structure(list(date = "Thu, 25 Mar 2021 15:23:55 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "176", 
        location = "/api/datasets/b5a775/", server = "nginx", 
