structure(list(url = "/api/datasets/8bf19e/forks/", status_code = 202L, 
    headers = structure(list(date = "Thu, 21 Nov 2024 18:53:54 GMT", 
        `content-type` = "application/json;charset=utf-8", `content-length` = "174", 
        location = "/api/datasets/d9661b/", server = "CherryPy/18.9.0", 
    ...
    "list")), all_headers = list(list(status = 202L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 21 Nov 2024 18:53:54 GMT", 
            ...
            `content-length` = "174", location = "/api/datasets/d9661b/", 
    ...
    date = structure(1732215234, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.6e-05, 
    connect = 0, pretransfer = 0.000173, starttransfer = 0.386958, 
    total = 0.386999)), class = "response")
